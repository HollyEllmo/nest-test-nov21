...
var AuditService = function () {
    ...
    var AuditService = _classThis = /** @class */ (function () {
        function AuditService_1(auditLogModel) {
            this.auditLogModel = auditLogModel;
        }
        AuditService_1.prototype.logAction = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.auditLogModel.create({
                                    action: data.action,
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { success: true, message: 'Audit log created' }];
                        case 2:
                            error_1 = _a.sent();
                            console.error('Error creating audit log:', error_1);
                            return [2 /*return*/, { success: false, message: 'Failed to create audit log' }];
                        case 3: return [2 /*return*/];
                    }
                });
            });
        };
        AuditService_1.prototype.ping = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { message: 'pong' }];
                });
            });
        };
        AuditService_1.prototype.findAll = function (filters) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.auditLogModel.findAll({
